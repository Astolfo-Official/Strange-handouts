...
那么自然而然，系统在粒子数表象下的总Fock空间可以被fragment和environment的两个子空间直和表示$V_{f+e} = V_f \oplus V_e$，则全空间的中的一个多电子波函数(在mean field语境下是一个行列式)可以被如下表示[\href{https://zhuanlan.zhihu.com/p/86137107}{ Schmidt 分解定理}]：
